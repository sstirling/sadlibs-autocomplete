...
function create_cards_house(data,town_val) {
 ...
 $('.house').append(
    $("<div class='legislators'><p>If you die under suspicious or strange circumstances, the <span class='robotext'>" + key.office + " Medical Examiner's Office</span> will be tasked with investigating your case.<br><br><p>This office completes <span class='robotext'>" + key.u60per + "% </span>of its cases in under 60 days, which <span class='robotext'>" + key.accred + " </span>make it eligible for accreditation from the National Association of Medical Examiners.<br><img src='accred-img/" + key.chart +"' width='100%'></div>")
  );
  $('.house').append(
